    ...
    return (
        <>
            ...
            {/* Título jmg */}
                ...
                {/* Hover me con animación */}
            <div className="div2 text-center p-5">
                    <div
                        class="relative overflow-hidden w-40 h-47 rounded-3xl cursor-pointer text-2xl font-bold "
                    >
            ...
            {/* Barra de navegación */}
                    ...
                    <div className="div3 p-5 ml-5 mb-5  ">
                        ...
                        <li>
                            <a href="#" className="nav-link pNav manrope-regular relative group text-gray-600 hover:text-black">
                                <span className="relative z-10 p-1 font-normal group-hover:font-bold">About Me</span> {/* El texto se vuelve negrita en hover */}
                                <span className="absolute left-1/2 -bottom-1 w-0 h-1 bg-[#d57536] transition-all group-hover:w-3/6 transform -translate-x-1/2"></span>
                                <span className="absolute right-1/2 -bottom-1 w-0 h-1 bg-[#d57536] transition-all group-hover:w-3/6 transform translate-x-1/2"></span>
                            </a>
                        ...
                        <li>
                            <a href="#" className="nav-link pNav manrope-regular relative group text-gray-600 hover:text-black">
                                <span className="relative z-10 p-1 font-normal group-hover:font-bold">Contact</span> {/* El texto se vuelve negrita en hover */}
                                <span className="absolute left-1/2 -bottom-1 w-0 h-1 bg-[#d57536] transition-all group-hover:w-3/6 transform -translate-x-1/2"></span>
                                <span className="absolute right-1/2 -bottom-1 w-0 h-1 bg-[#d57536] transition-all group-hover:w-3/6 transform translate-x-1/2"></span>
                            </a>
            ...
            {/* Nombre y título */}
                <div className="div4 text-center p-4 align-items-center">
                    ...
                    <h2 className="dotgothic16-regular display-6">{"{ Frontend Developer }"}</h2>
            </div>

            {/* Botón interactivo */}
                <div className="div5 text-center p-5">
                    
                    <section class="flex justify-center items-center">
                        <div class="flex items-center gap-4">
                            <div class="social-button">
                                <a href="https://www.instagram.com/javimontes20/" target="_blank">
                            ...
                            <div class="social-button">
                                <a href="https://github.com/Javimontes20" target="_blank">
                                    <button class="relative w-12 h-12 rounded-full group">
                                        <div
                            ...
                            <div class="social-button">
                                <a href="https://www.linkedin.com/in/javimontesgarcia/" target="_blank">
                                <button class="relative w-12 h-12 rounded-full group">
                                    <div
                            ...
                            <div class="social-button">
                                <a href="mailto:javimontesgarcia20@gmail.com" target="_blank">
                                <button class="relative w-12 h-12 rounded-full group">
                                    <div
